...
const parsedData = fs.readFileSync('parsedDataGrade6Maths.json', 'utf8');

// We want to replace the "Maths" array under "Grade 6":
// "Grade 6": {
//   "Maths": [
//     ...
//   ],
...
const grade6Index = curriculumContent.indexOf('"Grade 6": {');
const mathsStartIndex = curriculumContent.indexOf('"Maths": [', grade6Index);
...
if (mathsStartIndex > -1 && engStartIndex > -1) {
  ...
  console.log("Grade 6 Maths replaced successfully!");
} else {
