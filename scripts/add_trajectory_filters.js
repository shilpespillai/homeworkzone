...
// 1. Add state variables for subject and time range
content = content.replace(
  /const \[selectedReportStudent, setSelectedReportStudent\] = useState\(''\);/g,
...
// 2. Replace Calculations for Report C robustly
const startCalcIdx = content.indexOf('// Calculations for Report C: Growth Trajectory over time');
...
// 3. Replace the rendering of selectedReportTab === 'trajectory' tab controls
...
console.log('Successfully added subject and time range filters to Growth Trajectory!');
