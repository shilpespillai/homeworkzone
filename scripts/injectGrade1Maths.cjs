...
const parsedData = fs.readFileSync('parsedDataGrade1Maths.json', 'utf8');

// We want to replace the "Maths" array under "Grade 1":
// "Grade 1": {
//   "Maths": [
//     ...
//   ],
...
const grade1Index = curriculumContent.indexOf('"Grade 1": {');
const mathsStartIndex = curriculumContent.indexOf('"Maths": [', grade1Index);
...
if (mathsStartIndex > -1 && engStartIndex > -1) {
  ...
  console.log("Grade 1 Maths replaced successfully!");
} else {
