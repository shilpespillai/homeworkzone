...
const parsedData = fs.readFileSync('parsedDataGrade4Maths.json', 'utf8');

// We want to replace the "Maths" array under "Grade 4":
// "Grade 4": {
//   "Maths": [
//     ...
//   ],
...
const grade4Index = curriculumContent.indexOf('"Grade 4": {');
const mathsStartIndex = curriculumContent.indexOf('"Maths": [', grade4Index);
...
if (mathsStartIndex > -1 && engStartIndex > -1) {
  ...
  console.log("Grade 4 Maths replaced successfully!");
} else {
