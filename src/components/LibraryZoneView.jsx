...
export default function LibraryZoneView({ studentName, totalPoints, teacher, classroom, currentStudentProfile }) {
  ...
  const FEATURED_IDS = ['two_friends_one_heart', 'lion_and_the_mouse', 'tortoise_and_the_hare', 'dog_and_his_reflection', 'hare_and_the_hound', 'fox_and_the_grapes', 'honest_woodcutter', 'monkey_and_the_crocodile', 'clever_rabbit_and_the_lion', 'three_little_pigs', 'little_red_riding_hood', 'goldilocks_and_the_three_bears', 'jack_and_the_beanstalk', 'the_ugly_duckling', 'the_princess_and_the_pea', 'hansel_and_gretel', 'the_gingerbread_man', 'the_elves_and_the_shoemaker', 'the_emperors_new_clothes', 'the_bremen_town_musicians', 'the_little_red_hen', 'stone_soup', 'the_blue_jackal', 'the_lion_and_the_bull', 'the_monkey_and_the_wedge', 'jackal_and_the_drum', 'merchant_and_the_sweeper', 'the_crow_and_the_snake', 'the_camel_and_the_lion', 'the_heron_and_the_crab', 'the_lion_and_the_carpenter', 'boy_who_cried_wolf', 'crow_and_the_pitcher', 'ant_and_the_grasshopper', 'sonic_and_shadow'];
  ...
  const getStoryTimestamp = (s) => {
    ...
    if (String(s.id) === 'the_camel_and_the_lion') return 999999999999972;
    if (String(s.id) === 'the_heron_and_the_crab') return 999999999999971;
    if (String(s.id) === 'the_lion_and_the_carpenter') return 999999999999970;
    if (String(s.id) === 'boy_who_cried_wolf') return 999999999999969;
    if (String(s.id) === 'crow_and_the_pitcher') return 999999999999968;
    if (String(s.id) === 'ant_and_the_grasshopper') return 999999999999968;
    if (String(s.id) === 'sonic_and_shadow') return 999999999999967;
              ...
              <div className="space-y-6">
                ...
                {(() => {
                  const GENRE_COLLECTIONS = [
                    ...
                    { label: 'Panchatantra', emoji: '🐘', ids: ['monkey_and_the_crocodile', 'clever_rabbit_and_the_lion', 'the_blue_jackal', 'honest_woodcutter', 'the_lion_and_the_bull', 'the_monkey_and_the_wedge', 'jackal_and_the_drum', 'merchant_and_the_sweeper', 'the_crow_and_the_snake', 'the_camel_and_the_lion', 'the_heron_and_the_crab', 'the_lion_and_the_carpenter'] },
