...
export default function LibraryZoneView({ studentName, totalPoints, teacher, classroom, currentStudentProfile }) {
  ...
  const getStoryTimestamp = (s) => {
    ...
    if (String(s.id) === 'boy_who_cried_wolf') return 999999999999973;
    if (String(s.id) === 'crow_and_the_pitcher') return 999999999999972;
    if (String(s.id) === 'ant_and_the_grasshopper') return 999999999999971;
    if (String(s.id) === 'sonic_and_shadow') return 999999999999970;
              ...
              <div className="space-y-6">
                ...
                {(() => {
                  const GENRE_COLLECTIONS = [
                    ...
                    { label: 'Panchatantra', emoji: '🐘', ids: ['monkey_and_the_crocodile', 'clever_rabbit_and_the_lion', 'honest_woodcutter', 'the_lion_and_the_bull', 'the_monkey_and_the_wedge', 'jackal_and_the_drum', 'merchant_and_the_sweeper'] },
