              ...
              <div className="space-y-6">
                ...
                {(() => {
                  const GENRE_COLLECTIONS = [
                    ...
                    { label: 'Panchatantra', emoji: '🐘', ids: ['monkey_and_the_crocodile', 'clever_rabbit_and_the_lion', 'honest_woodcutter', 'the_lion_and_the_bull', 'the_monkey_and_the_wedge', 'jackal_and_the_drum', 'merchant_and_the_sweeper', 'the_crow_and_the_snake', 'the_camel_and_the_lion', 'the_heron_and_the_crab', 'the_lion_and_the_carpenter'] },
