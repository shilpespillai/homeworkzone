...
const TRACK_COORDS = {
  ...
  cyber: [
    { x: 110, y: 160 }, // 0 START (Node 1)
    { x: 300, y: 130 }, // 1 (Node 2)
    { x: 500, y: 140 }, // 2 (Node 3 - Unicorn)
    { x: 730, y: 140 }, // 3 (Node 4)
    { x: 910, y: 140 }, // 4 (Node 5)
    { x: 960, y: 300 }, // 5 (Node 6)
    { x: 160, y: 360 }, // 6 (Node 7 - Hover Loop)
    { x: 420, y: 380 }, // 7 (Node 8)
    { x: 640, y: 360 }, // 8 (Node 9)
    { x: 740, y: 460 }, // 9 (Node 10 prepad)
    { x: 840, y: 440 }  // 10 FINISH (Node 10)
  ],
  magic: [
