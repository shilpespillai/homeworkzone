      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-md space-y-4">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
              <div>
                <span className="text-[10px] font-black uppercase tracking-wider text-emerald-700 bg-emerald-100 px-3 py-1 rounded-md">
                  Visual Learning Guide • Healthy Eating Pyramid Chart
                </span>
                <h3 className="text-2xl font-black text-slate-800 mt-2 flex items-center gap-2">
                  <span>🖼️</span> Nutrition and Balanced Diet Infographic
                </h3>
                <p className="text-slate-500 text-xs mt-1">
                  Click the poster below to expand into full high-resolution view with food groups and nutrients.
                </p>
              </div>
              <button 
                onClick={() => setIsModalOpen(true)}
            ...
            >
              <img 
                src="/nutrition_and_balanced_diet_infographic.jpg?v=10" 
